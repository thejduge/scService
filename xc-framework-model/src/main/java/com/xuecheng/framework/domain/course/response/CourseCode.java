...
public enum CourseCode implements ResultCode {
    ...
    COURSE_INVALID_PARAM(false,31103,"参数非法！"),
    COURSE_ISNULL(false,31104,"课程信息为空！"),
    COURSE_NOTDOUND(false,31105,"课程信息为空！"),
    COURSE_PUBLISH_FAIL(false,31106,"课程发布失败！"),
    COURSE_GET_NOTEXISTS(false,31107,"获取课程信息失败！"),
    COURSE_PUBLISH_CREATE_INDEX_ERROR(false,31108,"创建课程索引信息失败！"),
    COURSE_MEDIA_TEACHPLAN_ISNULL(false,31109,"课程计划信息为空！"),
    COURSE_MEDIA_TEACHPLAN_GRADEERROR(false,31110,"课程计划信息节点等级错误！");
